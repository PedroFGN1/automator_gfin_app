...
async function executarRestituicaoIPVA(configPerfil, caminhoExcel, diretorioSaida, enviarLog, controle) {
    ...
    try {
        ...
        for (let i = 0; i < dados.length; i++) {
            ...
            try {
                ...
                await pptUtils.preencherTexto(contexto, 'txtCodigoMunicipio', linha[configPerfil.mapeamento_colunas.CODIGO_MUNICIPIO]);
                await navUtils.delay(300);
                ...
                // Registra Sucesso
                resultados.push({ status: 'SUCESSO',  linha: numLinha, dados: linha, mensagem: 'Processado com sucesso', numeroOP: numeroOP });
                logTotal(`   ✅ Sucesso!`);
...
module.exports = { executarRestituicaoIPVA };